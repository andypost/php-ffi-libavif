...
typedef struct avifImage
{
    ...
    uint8_t * yuvPlanes[3]; // AVIF_PLANE_COUNT_YUV
    uint32_t yuvRowBytes[3]; // AVIF_PLANE_COUNT_YUV
...
void avifImageCopy(avifImage * dstImage, const avifImage * srcImage, avifPlanesFlags planes); // deep copy
...
void avifImageAllocatePlanes(avifImage * image, avifPlanesFlags planes); // Ignores any pre-existing planes
